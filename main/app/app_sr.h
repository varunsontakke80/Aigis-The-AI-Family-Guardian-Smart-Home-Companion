...
typedef enum {
    ...
    SR_CMD_TURN_ON_LIGHT_ONE,
    SR_CMD_TURN_OFF_LIGHT_ONE,
    SR_CMD_TURN_ON_SOCKET,
    SR_CMD_TURN_OFF_SOCKET,
    SR_CMD_TURN_ON_FAN_AT_LEVEL_ONE,
    SR_CMD_TURN_ON_FAN_AT_LEVEL_TWO,
    SR_CMD_TURN_ON_FAN_AT_LEVEL_THREE,
    SR_CMD_TURN_OFF_FAN,
    //door control Door Node
    SR_CMD_LOCK_THE_DOOR,
    SR_CMD_UNLOCK_THE_DOOR,
    //robot control
    SR_CMD_WALK_FORWARD_AIGIS,
    SR_CMD_STOP_AIGIS,
    SR_CMD_LETS_DANCE_AIGIS,
    SR_CMD_TELL_A_STORY,
    //Health node
    SR_CMD_CHECK_HEALTH,
    //Music control
